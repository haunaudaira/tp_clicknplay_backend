...
router.put('/productos/modificar/:id', reqAutorizacion, ProductoMiddleware.validarId, uploadMiddleware.single('imagen'), ProductoMiddleware.validarDatosProducto, controladorProductos.procesarEdicion);
router.put('/productos/:id/estado', reqAutorizacion, ProductoMiddleware.validarId, controladorProductos.cambiarEstadoProducto);
